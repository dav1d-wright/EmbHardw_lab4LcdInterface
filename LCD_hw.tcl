...
add_fileset_file dFlipFlop.vhdl VHDL PATH dFlipFlop.vhdl
...
add_interface_port avalon_slave BeginBurstTransfer_DI beginbursttransfer Input 1
...
add_interface_port conduit_end DC_NSO dc_n Output 1
