...
$(MEM_1)_START := 0x02041000
$(MEM_1)_END := 0x02041fff
$(MEM_1)_SPAN := 0x00001000
$(MEM_1)_HIERARCHICAL_PATH := TCDM
$(MEM_1)_WIDTH := 32
...
.PHONY: TCDM
TCDM: check_elf_exists $(MEM_INIT_DIR)/$(MEM_1).hex $(HDL_SIM_DIR)/$(MEM_1).dat $(HDL_SIM_DIR)/$(MEM_1).sym

# Memory: TCIM
MEM_2 := systemFile_TCIM
$(MEM_2)_NAME := TCIM
...
$(MEM_2)_START := 0x02040000
$(MEM_2)_END := 0x02040fff
$(MEM_2)_SPAN := 0x00001000
$(MEM_2)_HIERARCHICAL_PATH := TCIM
$(MEM_2)_WIDTH := 32
...
.PHONY: TCIM
TCIM: check_elf_exists $(MEM_INIT_DIR)/$(MEM_2).hex $(HDL_SIM_DIR)/$(MEM_2).dat $(HDL_SIM_DIR)/$(MEM_2).sym
