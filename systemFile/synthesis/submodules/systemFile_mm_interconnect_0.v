...
module systemFile_mm_interconnect_0 (
		...
		output wire [1:0]  LCD_LCD_AVALON_SLAVE_address,                               //                                 LCD_LCD_AVALON_SLAVE.address
		output wire        LCD_LCD_AVALON_SLAVE_write,                                 //                                                     .write
		output wire        LCD_LCD_AVALON_SLAVE_read,                                  //                                                     .read
		input  wire [15:0] LCD_LCD_AVALON_SLAVE_readdata,                              //                                                     .readdata
		output wire [15:0] LCD_LCD_AVALON_SLAVE_writedata,                             //                                                     .writedata
		output wire        LCD_LCD_AVALON_SLAVE_beginbursttransfer,                    //                                                     .beginbursttransfer
		output wire [7:0]  LCD_LCD_AVALON_SLAVE_burstcount,                            //                                                     .burstcount
		output wire [1:0]  LCD_LCD_AVALON_SLAVE_byteenable,                            //                                                     .byteenable
		input  wire        LCD_LCD_AVALON_SLAVE_readdatavalid,                         //                                                     .readdatavalid
		input  wire        LCD_LCD_AVALON_SLAVE_waitrequest,                           //                                                     .waitrequest
	...
	wire   [15:0] lcd_lcd_avalon_slave_agent_m0_readdata;                                    // LCD_LCD_AVALON_SLAVE_translator:uav_readdata -> LCD_LCD_AVALON_SLAVE_agent:m0_readdata
	wire          lcd_lcd_avalon_slave_agent_m0_waitrequest;                                 // LCD_LCD_AVALON_SLAVE_translator:uav_waitrequest -> LCD_LCD_AVALON_SLAVE_agent:m0_waitrequest
	wire          lcd_lcd_avalon_slave_agent_m0_debugaccess;                                 // LCD_LCD_AVALON_SLAVE_agent:m0_debugaccess -> LCD_LCD_AVALON_SLAVE_translator:uav_debugaccess
	wire   [25:0] lcd_lcd_avalon_slave_agent_m0_address;                                     // LCD_LCD_AVALON_SLAVE_agent:m0_address -> LCD_LCD_AVALON_SLAVE_translator:uav_address
	wire    [1:0] lcd_lcd_avalon_slave_agent_m0_byteenable;                                  // LCD_LCD_AVALON_SLAVE_agent:m0_byteenable -> LCD_LCD_AVALON_SLAVE_translator:uav_byteenable
	wire          lcd_lcd_avalon_slave_agent_m0_read;                                        // LCD_LCD_AVALON_SLAVE_agent:m0_read -> LCD_LCD_AVALON_SLAVE_translator:uav_read
	wire          lcd_lcd_avalon_slave_agent_m0_readdatavalid;                               // LCD_LCD_AVALON_SLAVE_translator:uav_readdatavalid -> LCD_LCD_AVALON_SLAVE_agent:m0_readdatavalid
	wire          lcd_lcd_avalon_slave_agent_m0_lock;                                        // LCD_LCD_AVALON_SLAVE_agent:m0_lock -> LCD_LCD_AVALON_SLAVE_translator:uav_lock
	wire   [15:0] lcd_lcd_avalon_slave_agent_m0_writedata;                                   // LCD_LCD_AVALON_SLAVE_agent:m0_writedata -> LCD_LCD_AVALON_SLAVE_translator:uav_writedata
	wire          lcd_lcd_avalon_slave_agent_m0_write;                                       // LCD_LCD_AVALON_SLAVE_agent:m0_write -> LCD_LCD_AVALON_SLAVE_translator:uav_write
	wire    [8:0] lcd_lcd_avalon_slave_agent_m0_burstcount;                                  // LCD_LCD_AVALON_SLAVE_agent:m0_burstcount -> LCD_LCD_AVALON_SLAVE_translator:uav_burstcount
	wire          lcd_lcd_avalon_slave_agent_rf_source_valid;                                // LCD_LCD_AVALON_SLAVE_agent:rf_source_valid -> LCD_LCD_AVALON_SLAVE_agent_rsp_fifo:in_valid
	wire   [92:0] lcd_lcd_avalon_slave_agent_rf_source_data;                                 // LCD_LCD_AVALON_SLAVE_agent:rf_source_data -> LCD_LCD_AVALON_SLAVE_agent_rsp_fifo:in_data
	wire          lcd_lcd_avalon_slave_agent_rf_source_ready;                                // LCD_LCD_AVALON_SLAVE_agent_rsp_fifo:in_ready -> LCD_LCD_AVALON_SLAVE_agent:rf_source_ready
	wire          lcd_lcd_avalon_slave_agent_rf_source_startofpacket;                        // LCD_LCD_AVALON_SLAVE_agent:rf_source_startofpacket -> LCD_LCD_AVALON_SLAVE_agent_rsp_fifo:in_startofpacket
	wire          lcd_lcd_avalon_slave_agent_rf_source_endofpacket;                          // LCD_LCD_AVALON_SLAVE_agent:rf_source_endofpacket -> LCD_LCD_AVALON_SLAVE_agent_rsp_fifo:in_endofpacket
	wire          lcd_lcd_avalon_slave_agent_rsp_fifo_out_valid;                             // LCD_LCD_AVALON_SLAVE_agent_rsp_fifo:out_valid -> LCD_LCD_AVALON_SLAVE_agent:rf_sink_valid
	wire   [92:0] lcd_lcd_avalon_slave_agent_rsp_fifo_out_data;                              // LCD_LCD_AVALON_SLAVE_agent_rsp_fifo:out_data -> LCD_LCD_AVALON_SLAVE_agent:rf_sink_data
	wire          lcd_lcd_avalon_slave_agent_rsp_fifo_out_ready;                             // LCD_LCD_AVALON_SLAVE_agent:rf_sink_ready -> LCD_LCD_AVALON_SLAVE_agent_rsp_fifo:out_ready
	wire          lcd_lcd_avalon_slave_agent_rsp_fifo_out_startofpacket;                     // LCD_LCD_AVALON_SLAVE_agent_rsp_fifo:out_startofpacket -> LCD_LCD_AVALON_SLAVE_agent:rf_sink_startofpacket
	wire          lcd_lcd_avalon_slave_agent_rsp_fifo_out_endofpacket;                       // LCD_LCD_AVALON_SLAVE_agent_rsp_fifo:out_endofpacket -> LCD_LCD_AVALON_SLAVE_agent:rf_sink_endofpacket
	...
	wire  [109:0] cmd_mux_001_src_data;                                                      // cmd_mux_001:src_data -> jtag_uart_avalon_jtag_slave_agent:cp_data
	wire          cmd_mux_001_src_ready;                                                     // jtag_uart_avalon_jtag_slave_agent:cp_ready -> cmd_mux_001:src_ready
	wire    [8:0] cmd_mux_001_src_channel;                                                   // cmd_mux_001:src_channel -> jtag_uart_avalon_jtag_slave_agent:cp_channel
	...
	wire  [109:0] cmd_mux_008_src_data;                                                      // cmd_mux_008:src_data -> TCIM_s2_agent:cp_data
	...
	wire          lcd_lcd_avalon_slave_agent_rp_valid;                                       // LCD_LCD_AVALON_SLAVE_agent:rp_valid -> router_002:sink_valid
	wire   [91:0] lcd_lcd_avalon_slave_agent_rp_data;                                        // LCD_LCD_AVALON_SLAVE_agent:rp_data -> router_002:sink_data
	wire          lcd_lcd_avalon_slave_agent_rp_ready;                                       // router_002:sink_ready -> LCD_LCD_AVALON_SLAVE_agent:rp_ready
	wire          lcd_lcd_avalon_slave_agent_rp_startofpacket;                               // LCD_LCD_AVALON_SLAVE_agent:rp_startofpacket -> router_002:sink_startofpacket
	wire          lcd_lcd_avalon_slave_agent_rp_endofpacket;                                 // LCD_LCD_AVALON_SLAVE_agent:rp_endofpacket -> router_002:sink_endofpacket
	...
	wire   [91:0] sdram_ctrl_s1_agent_rp_data;                                               // SDRAM_ctrl_s1_agent:rp_data -> router_008:sink_data
	...
	wire  [109:0] timer_0_s1_agent_rp_data;                                                  // timer_0_s1_agent:rp_data -> router_009:sink_data
	...
	wire  [109:0] tcim_s2_agent_rp_data;                                                     // TCIM_s2_agent:rp_data -> router_010:sink_data
	...
	wire  [109:0] cmd_demux_001_src2_data;                                                   // cmd_demux_001:src2_data -> cmd_mux_006:sink1_data
	...
	wire  [109:0] rsp_demux_006_src1_data;                                                   // rsp_demux_006:src1_data -> rsp_mux_001:sink2_data
	...
	wire          cmd_mux_src_valid;                                                         // cmd_mux:src_valid -> LCD_LCD_AVALON_SLAVE_cmd_width_adapter:in_valid
	wire  [109:0] cmd_mux_src_data;                                                          // cmd_mux:src_data -> LCD_LCD_AVALON_SLAVE_cmd_width_adapter:in_data
	wire          cmd_mux_src_ready;                                                         // LCD_LCD_AVALON_SLAVE_cmd_width_adapter:in_ready -> cmd_mux:src_ready
	wire    [8:0] cmd_mux_src_channel;                                                       // cmd_mux:src_channel -> LCD_LCD_AVALON_SLAVE_cmd_width_adapter:in_channel
	wire          cmd_mux_src_startofpacket;                                                 // cmd_mux:src_startofpacket -> LCD_LCD_AVALON_SLAVE_cmd_width_adapter:in_startofpacket
	wire          cmd_mux_src_endofpacket;                                                   // cmd_mux:src_endofpacket -> LCD_LCD_AVALON_SLAVE_cmd_width_adapter:in_endofpacket
	wire          lcd_lcd_avalon_slave_cmd_width_adapter_src_valid;                          // LCD_LCD_AVALON_SLAVE_cmd_width_adapter:out_valid -> LCD_LCD_AVALON_SLAVE_agent:cp_valid
	wire   [91:0] lcd_lcd_avalon_slave_cmd_width_adapter_src_data;                           // LCD_LCD_AVALON_SLAVE_cmd_width_adapter:out_data -> LCD_LCD_AVALON_SLAVE_agent:cp_data
	wire          lcd_lcd_avalon_slave_cmd_width_adapter_src_ready;                          // LCD_LCD_AVALON_SLAVE_agent:cp_ready -> LCD_LCD_AVALON_SLAVE_cmd_width_adapter:out_ready
	wire    [8:0] lcd_lcd_avalon_slave_cmd_width_adapter_src_channel;                        // LCD_LCD_AVALON_SLAVE_cmd_width_adapter:out_channel -> LCD_LCD_AVALON_SLAVE_agent:cp_channel
	wire          lcd_lcd_avalon_slave_cmd_width_adapter_src_startofpacket;                  // LCD_LCD_AVALON_SLAVE_cmd_width_adapter:out_startofpacket -> LCD_LCD_AVALON_SLAVE_agent:cp_startofpacket
	wire          lcd_lcd_avalon_slave_cmd_width_adapter_src_endofpacket;                    // LCD_LCD_AVALON_SLAVE_cmd_width_adapter:out_endofpacket -> LCD_LCD_AVALON_SLAVE_agent:cp_endofpacket
	wire          router_002_src_valid;                                                      // router_002:src_valid -> LCD_LCD_AVALON_SLAVE_rsp_width_adapter:in_valid
	wire   [91:0] router_002_src_data;                                                       // router_002:src_data -> LCD_LCD_AVALON_SLAVE_rsp_width_adapter:in_data
	wire          router_002_src_ready;                                                      // LCD_LCD_AVALON_SLAVE_rsp_width_adapter:in_ready -> router_002:src_ready
	wire    [8:0] router_002_src_channel;                                                    // router_002:src_channel -> LCD_LCD_AVALON_SLAVE_rsp_width_adapter:in_channel
	wire          router_002_src_startofpacket;                                              // router_002:src_startofpacket -> LCD_LCD_AVALON_SLAVE_rsp_width_adapter:in_startofpacket
	wire          router_002_src_endofpacket;                                                // router_002:src_endofpacket -> LCD_LCD_AVALON_SLAVE_rsp_width_adapter:in_endofpacket
	wire          lcd_lcd_avalon_slave_rsp_width_adapter_src_valid;                          // LCD_LCD_AVALON_SLAVE_rsp_width_adapter:out_valid -> rsp_demux:sink_valid
	wire  [109:0] lcd_lcd_avalon_slave_rsp_width_adapter_src_data;                           // LCD_LCD_AVALON_SLAVE_rsp_width_adapter:out_data -> rsp_demux:sink_data
	wire          lcd_lcd_avalon_slave_rsp_width_adapter_src_ready;                          // rsp_demux:sink_ready -> LCD_LCD_AVALON_SLAVE_rsp_width_adapter:out_ready
	wire    [8:0] lcd_lcd_avalon_slave_rsp_width_adapter_src_channel;                        // LCD_LCD_AVALON_SLAVE_rsp_width_adapter:out_channel -> rsp_demux:sink_channel
	wire          lcd_lcd_avalon_slave_rsp_width_adapter_src_startofpacket;                  // LCD_LCD_AVALON_SLAVE_rsp_width_adapter:out_startofpacket -> rsp_demux:sink_startofpacket
	wire          lcd_lcd_avalon_slave_rsp_width_adapter_src_endofpacket;                    // LCD_LCD_AVALON_SLAVE_rsp_width_adapter:out_endofpacket -> rsp_demux:sink_endofpacket
	wire          router_008_src_valid;                                                      // router_008:src_valid -> SDRAM_ctrl_s1_rsp_width_adapter:in_valid
	wire   [91:0] router_008_src_data;                                                       // router_008:src_data -> SDRAM_ctrl_s1_rsp_width_adapter:in_data
	...
	wire  [109:0] sdram_ctrl_s1_rsp_width_adapter_src_data;                                  // SDRAM_ctrl_s1_rsp_width_adapter:out_data -> rsp_demux_006:sink_data
	...
	wire  [109:0] cmd_mux_006_src_data;                                                      // cmd_mux_006:src_data -> SDRAM_ctrl_s1_cmd_width_adapter:in_data
	...
	wire          lcd_lcd_avalon_slave_agent_rdata_fifo_src_valid;                           // LCD_LCD_AVALON_SLAVE_agent:rdata_fifo_src_valid -> avalon_st_adapter:in_0_valid
	wire   [17:0] lcd_lcd_avalon_slave_agent_rdata_fifo_src_data;                            // LCD_LCD_AVALON_SLAVE_agent:rdata_fifo_src_data -> avalon_st_adapter:in_0_data
	wire          lcd_lcd_avalon_slave_agent_rdata_fifo_src_ready;                           // avalon_st_adapter:in_0_ready -> LCD_LCD_AVALON_SLAVE_agent:rdata_fifo_src_ready
	wire          avalon_st_adapter_out_0_valid;                                             // avalon_st_adapter:out_0_valid -> LCD_LCD_AVALON_SLAVE_agent:rdata_fifo_sink_valid
	wire   [17:0] avalon_st_adapter_out_0_data;                                              // avalon_st_adapter:out_0_data -> LCD_LCD_AVALON_SLAVE_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_out_0_ready;                                             // LCD_LCD_AVALON_SLAVE_agent:rdata_fifo_sink_ready -> avalon_st_adapter:out_0_ready
	wire    [0:0] avalon_st_adapter_out_0_error;                                             // avalon_st_adapter:out_0_error -> LCD_LCD_AVALON_SLAVE_agent:rdata_fifo_sink_error
	...
	) lcd_lcd_avalon_slave_translator (
		.clk                    (altpll_0_c0_clk),                             //                      clk.clk
		.reset                  (CPU_reset_reset_bridge_in_reset_reset),       //                    reset.reset
		.uav_address            (lcd_lcd_avalon_slave_agent_m0_address),       // avalon_universal_slave_0.address
		.uav_burstcount         (lcd_lcd_avalon_slave_agent_m0_burstcount),    //                         .burstcount
		.uav_read               (lcd_lcd_avalon_slave_agent_m0_read),          //                         .read
		.uav_write              (lcd_lcd_avalon_slave_agent_m0_write),         //                         .write
		.uav_waitrequest        (lcd_lcd_avalon_slave_agent_m0_waitrequest),   //                         .waitrequest
		.uav_readdatavalid      (lcd_lcd_avalon_slave_agent_m0_readdatavalid), //                         .readdatavalid
		.uav_byteenable         (lcd_lcd_avalon_slave_agent_m0_byteenable),    //                         .byteenable
		.uav_readdata           (lcd_lcd_avalon_slave_agent_m0_readdata),      //                         .readdata
		.uav_writedata          (lcd_lcd_avalon_slave_agent_m0_writedata),     //                         .writedata
		.uav_lock               (lcd_lcd_avalon_slave_agent_m0_lock),          //                         .lock
		.uav_debugaccess        (lcd_lcd_avalon_slave_agent_m0_debugaccess),   //                         .debugaccess
		.av_address             (LCD_LCD_AVALON_SLAVE_address),                //      avalon_anti_slave_0.address
		.av_write               (LCD_LCD_AVALON_SLAVE_write),                  //                         .write
		.av_read                (LCD_LCD_AVALON_SLAVE_read),                   //                         .read
		.av_readdata            (LCD_LCD_AVALON_SLAVE_readdata),               //                         .readdata
		.av_writedata           (LCD_LCD_AVALON_SLAVE_writedata),              //                         .writedata
		.av_beginbursttransfer  (LCD_LCD_AVALON_SLAVE_beginbursttransfer),     //                         .beginbursttransfer
		.av_burstcount          (LCD_LCD_AVALON_SLAVE_burstcount),             //                         .burstcount
		.av_byteenable          (LCD_LCD_AVALON_SLAVE_byteenable),             //                         .byteenable
		.av_readdatavalid       (LCD_LCD_AVALON_SLAVE_readdatavalid),          //                         .readdatavalid
		.av_waitrequest         (LCD_LCD_AVALON_SLAVE_waitrequest),            //                         .waitrequest
	...
	altera_merlin_slave_agent #(
		...
		.clk                     (altpll_0_c0_clk),                                          //             clk.clk
		.reset                   (CPU_reset_reset_bridge_in_reset_reset),                    //       clk_reset.reset
		.m0_address              (lcd_lcd_avalon_slave_agent_m0_address),                    //              m0.address
		.m0_burstcount           (lcd_lcd_avalon_slave_agent_m0_burstcount),                 //                .burstcount
		.m0_byteenable           (lcd_lcd_avalon_slave_agent_m0_byteenable),                 //                .byteenable
		.m0_debugaccess          (lcd_lcd_avalon_slave_agent_m0_debugaccess),                //                .debugaccess
		.m0_lock                 (lcd_lcd_avalon_slave_agent_m0_lock),                       //                .lock
		.m0_readdata             (lcd_lcd_avalon_slave_agent_m0_readdata),                   //                .readdata
		.m0_readdatavalid        (lcd_lcd_avalon_slave_agent_m0_readdatavalid),              //                .readdatavalid
		.m0_read                 (lcd_lcd_avalon_slave_agent_m0_read),                       //                .read
		.m0_waitrequest          (lcd_lcd_avalon_slave_agent_m0_waitrequest),                //                .waitrequest
		.m0_writedata            (lcd_lcd_avalon_slave_agent_m0_writedata),                  //                .writedata
		.m0_write                (lcd_lcd_avalon_slave_agent_m0_write),                      //                .write
		.rp_endofpacket          (lcd_lcd_avalon_slave_agent_rp_endofpacket),                //              rp.endofpacket
		.rp_ready                (lcd_lcd_avalon_slave_agent_rp_ready),                      //                .ready
		.rp_valid                (lcd_lcd_avalon_slave_agent_rp_valid),                      //                .valid
		.rp_data                 (lcd_lcd_avalon_slave_agent_rp_data),                       //                .data
		.rp_startofpacket        (lcd_lcd_avalon_slave_agent_rp_startofpacket),              //                .startofpacket
		.cp_ready                (lcd_lcd_avalon_slave_cmd_width_adapter_src_ready),         //              cp.ready
		.cp_valid                (lcd_lcd_avalon_slave_cmd_width_adapter_src_valid),         //                .valid
		.cp_data                 (lcd_lcd_avalon_slave_cmd_width_adapter_src_data),          //                .data
		.cp_startofpacket        (lcd_lcd_avalon_slave_cmd_width_adapter_src_startofpacket), //                .startofpacket
		.cp_endofpacket          (lcd_lcd_avalon_slave_cmd_width_adapter_src_endofpacket),   //                .endofpacket
		.cp_channel              (lcd_lcd_avalon_slave_cmd_width_adapter_src_channel),       //                .channel
		.rf_sink_ready           (lcd_lcd_avalon_slave_agent_rsp_fifo_out_ready),            //         rf_sink.ready
		.rf_sink_valid           (lcd_lcd_avalon_slave_agent_rsp_fifo_out_valid),            //                .valid
		.rf_sink_startofpacket   (lcd_lcd_avalon_slave_agent_rsp_fifo_out_startofpacket),    //                .startofpacket
		.rf_sink_endofpacket     (lcd_lcd_avalon_slave_agent_rsp_fifo_out_endofpacket),      //                .endofpacket
		.rf_sink_data            (lcd_lcd_avalon_slave_agent_rsp_fifo_out_data),             //                .data
		.rf_source_ready         (lcd_lcd_avalon_slave_agent_rf_source_ready),               //       rf_source.ready
		.rf_source_valid         (lcd_lcd_avalon_slave_agent_rf_source_valid),               //                .valid
		.rf_source_startofpacket (lcd_lcd_avalon_slave_agent_rf_source_startofpacket),       //                .startofpacket
		.rf_source_endofpacket   (lcd_lcd_avalon_slave_agent_rf_source_endofpacket),         //                .endofpacket
		.rf_source_data          (lcd_lcd_avalon_slave_agent_rf_source_data),                //                .data
		.rdata_fifo_sink_ready   (avalon_st_adapter_out_0_ready),                            // rdata_fifo_sink.ready
		.rdata_fifo_sink_valid   (avalon_st_adapter_out_0_valid),                            //                .valid
		.rdata_fifo_sink_data    (avalon_st_adapter_out_0_data),                             //                .data
		.rdata_fifo_sink_error   (avalon_st_adapter_out_0_error),                            //                .error
		.rdata_fifo_src_ready    (lcd_lcd_avalon_slave_agent_rdata_fifo_src_ready),          //  rdata_fifo_src.ready
		.rdata_fifo_src_valid    (lcd_lcd_avalon_slave_agent_rdata_fifo_src_valid),          //                .valid
		.rdata_fifo_src_data     (lcd_lcd_avalon_slave_agent_rdata_fifo_src_data),           //                .data
	...
	altera_avalon_sc_fifo #(
		...
		.clk               (altpll_0_c0_clk),                                       //       clk.clk
		.reset             (CPU_reset_reset_bridge_in_reset_reset),                 // clk_reset.reset
		.in_data           (lcd_lcd_avalon_slave_agent_rf_source_data),             //        in.data
		.in_valid          (lcd_lcd_avalon_slave_agent_rf_source_valid),            //          .valid
		.in_ready          (lcd_lcd_avalon_slave_agent_rf_source_ready),            //          .ready
		.in_startofpacket  (lcd_lcd_avalon_slave_agent_rf_source_startofpacket),    //          .startofpacket
		.in_endofpacket    (lcd_lcd_avalon_slave_agent_rf_source_endofpacket),      //          .endofpacket
		.out_data          (lcd_lcd_avalon_slave_agent_rsp_fifo_out_data),          //       out.data
		.out_valid         (lcd_lcd_avalon_slave_agent_rsp_fifo_out_valid),         //          .valid
		.out_ready         (lcd_lcd_avalon_slave_agent_rsp_fifo_out_ready),         //          .ready
		.out_startofpacket (lcd_lcd_avalon_slave_agent_rsp_fifo_out_startofpacket), //          .startofpacket
		.out_endofpacket   (lcd_lcd_avalon_slave_agent_rsp_fifo_out_endofpacket),   //          .endofpacket
	...
	systemFile_mm_interconnect_0_router_002 router_002 (
		.sink_ready         (lcd_lcd_avalon_slave_agent_rp_ready),         //      sink.ready
		.sink_valid         (lcd_lcd_avalon_slave_agent_rp_valid),         //          .valid
		.sink_data          (lcd_lcd_avalon_slave_agent_rp_data),          //          .data
		.sink_startofpacket (lcd_lcd_avalon_slave_agent_rp_startofpacket), //          .startofpacket
		.sink_endofpacket   (lcd_lcd_avalon_slave_agent_rp_endofpacket),   //          .endofpacket
		.clk                (altpll_0_c0_clk),                             //       clk.clk
		.reset              (CPU_reset_reset_bridge_in_reset_reset),       // clk_reset.reset
	...
	systemFile_mm_interconnect_0_router_003 router_006 (
	...
	systemFile_mm_interconnect_0_cmd_mux cmd_mux_002 (
		.clk                 (altpll_0_c0_clk),                       //       clk.clk
		.reset               (CPU_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	systemFile_mm_interconnect_0_cmd_mux cmd_mux_003 (
		.clk                 (altpll_0_c0_clk),                       //       clk.clk
		.reset               (CPU_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	systemFile_mm_interconnect_0_cmd_mux_001 cmd_mux_004 (
		.clk                 (altpll_0_c0_clk),                       //       clk.clk
		.reset               (CPU_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	systemFile_mm_interconnect_0_cmd_mux cmd_mux_005 (
		.clk                 (clk_0_clk_clk),                                              //       clk.clk
		.reset               (altpll_0_inclk_interface_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	systemFile_mm_interconnect_0_cmd_mux cmd_mux_008 (
		.clk                 (altpll_0_c0_clk),                       //       clk.clk
		.reset               (CPU_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	systemFile_mm_interconnect_0_rsp_demux rsp_demux (
		.clk                (altpll_0_c0_clk),                                          //       clk.clk
		.reset              (CPU_reset_reset_bridge_in_reset_reset),                    // clk_reset.reset
		.sink_ready         (lcd_lcd_avalon_slave_rsp_width_adapter_src_ready),         //      sink.ready
		.sink_channel       (lcd_lcd_avalon_slave_rsp_width_adapter_src_channel),       //          .channel
		.sink_data          (lcd_lcd_avalon_slave_rsp_width_adapter_src_data),          //          .data
		.sink_startofpacket (lcd_lcd_avalon_slave_rsp_width_adapter_src_startofpacket), //          .startofpacket
		.sink_endofpacket   (lcd_lcd_avalon_slave_rsp_width_adapter_src_endofpacket),   //          .endofpacket
		.sink_valid         (lcd_lcd_avalon_slave_rsp_width_adapter_src_valid),         //          .valid
	...
	systemFile_mm_interconnect_0_rsp_demux rsp_demux_002 (
		.clk                (altpll_0_c0_clk),                       //       clk.clk
		.reset              (CPU_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	systemFile_mm_interconnect_0_rsp_demux rsp_demux_003 (
		.clk                (altpll_0_c0_clk),                       //       clk.clk
		.reset              (CPU_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	systemFile_mm_interconnect_0_rsp_demux_001 rsp_demux_004 (
		.clk                (altpll_0_c0_clk),                       //       clk.clk
		.reset              (CPU_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	systemFile_mm_interconnect_0_rsp_demux rsp_demux_005 (
		.clk                (clk_0_clk_clk),                                              //       clk.clk
		.reset              (altpll_0_inclk_interface_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	systemFile_mm_interconnect_0_rsp_demux rsp_demux_008 (
		.clk                (altpll_0_c0_clk),                       //       clk.clk
		.reset              (CPU_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	altera_merlin_width_adapter #(
	...
	) lcd_lcd_avalon_slave_cmd_width_adapter (
		.clk                  (altpll_0_c0_clk),                                          //       clk.clk
		.reset                (CPU_reset_reset_bridge_in_reset_reset),                    // clk_reset.reset
		...
		.out_endofpacket      (lcd_lcd_avalon_slave_cmd_width_adapter_src_endofpacket),   //       src.endofpacket
		.out_data             (lcd_lcd_avalon_slave_cmd_width_adapter_src_data),          //          .data
		.out_channel          (lcd_lcd_avalon_slave_cmd_width_adapter_src_channel),       //          .channel
		.out_valid            (lcd_lcd_avalon_slave_cmd_width_adapter_src_valid),         //          .valid
		.out_ready            (lcd_lcd_avalon_slave_cmd_width_adapter_src_ready),         //          .ready
		.out_startofpacket    (lcd_lcd_avalon_slave_cmd_width_adapter_src_startofpacket), //          .startofpacket
	...
	altera_merlin_width_adapter #(
		...
		.out_endofpacket      (lcd_lcd_avalon_slave_rsp_width_adapter_src_endofpacket),   //       src.endofpacket
		.out_data             (lcd_lcd_avalon_slave_rsp_width_adapter_src_data),          //          .data
		.out_channel          (lcd_lcd_avalon_slave_rsp_width_adapter_src_channel),       //          .channel
		.out_valid            (lcd_lcd_avalon_slave_rsp_width_adapter_src_valid),         //          .valid
		.out_ready            (lcd_lcd_avalon_slave_rsp_width_adapter_src_ready),         //          .ready
		.out_startofpacket    (lcd_lcd_avalon_slave_rsp_width_adapter_src_startofpacket), //          .startofpacket
		.in_command_size_data (3'b000)                                                    // (terminated)
	);
	...
	systemFile_mm_interconnect_0_avalon_st_adapter #(
		...
		.in_0_data      (lcd_lcd_avalon_slave_agent_rdata_fifo_src_data),  //     in_0.data
		.in_0_valid     (lcd_lcd_avalon_slave_agent_rdata_fifo_src_valid), //         .valid
		.in_0_ready     (lcd_lcd_avalon_slave_agent_rdata_fifo_src_ready), //         .ready
