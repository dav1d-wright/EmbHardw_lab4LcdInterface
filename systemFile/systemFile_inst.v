	systemFile u0 (
		...
		.altpll_1_c0_clk            (<connected-to-altpll_1_c0_clk>),            //     altpll_1_c0.clk
		...
		.lcd_conduit_end_cs_n       (<connected-to-lcd_conduit_end_cs_n>),       // lcd_conduit_end.cs_n
		.lcd_conduit_end_data       (<connected-to-lcd_conduit_end_data>),       //                .data
		.lcd_conduit_end_data_cmd_n (<connected-to-lcd_conduit_end_data_cmd_n>), //                .data_cmd_n
		.lcd_conduit_end_mode       (<connected-to-lcd_conduit_end_mode>),       //                .mode
		.lcd_conduit_end_rd_n       (<connected-to-lcd_conduit_end_rd_n>),       //                .rd_n
		.lcd_conduit_end_wr_n       (<connected-to-lcd_conduit_end_wr_n>),       //                .wr_n
		.lcd_conduit_end_lcdreset_n (<connected-to-lcd_conduit_end_lcdreset_n>)  //                .lcdreset_n
	);
